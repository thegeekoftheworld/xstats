...
(function() {
  var Application, Config, GaugeWrapper, colouredSeries, toObject;
  ...
  Application = (function() {
    ...
    Application.prototype.handleWebsocketMessage = function(data) {
      var hostname, packet, rxPct, time, txPct, usedMemory;
      packet = $.parseJSON(data);
      hostname = packet.host;
      time = new Date().getTime();
      switch (packet.module) {
        case "network":
          this.series[hostname]["tx-val"].append(time, packet.data['bytes-sent']);
          this.series[hostname]["rx-val"].append(time, packet.data['bytes-recv']);
          ...
          return this.series[hostname]["rx-pct"].append(time, rxPct);
        case "memory":
